...
bool Coloring::simplify() { return false; }

// return true if changed anything, false otherwise
bool Coloring::coalesce() { return false; }

// freeze the moves that are not coalesced
// return true if changed anything, false otherwise
bool Coloring::freeze() { return false; }
